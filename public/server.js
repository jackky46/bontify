(function () {
  ...
  function retrieveTracks(timeRangeSlug, domNumber, domPeriod, quantity) {
    $.ajax({
      url: `https://api.spotify.com/v1/me/top/tracks?limit=${quantity}&time_range=${timeRangeSlug}`,
      headers: {
  ...
  if (error) {
    ...
    document.getElementById("short_term").addEventListener(
      "click",
      function () {
        document.getElementById("query1").addEventListener(
          "click",
          function () {
            retrieveTracks("short_term", 1, "LAST MONTH", 5);
          }
        );
        document.getElementById("query2").addEventListener(
          "click",
          function () {
            retrieveTracks("short_term", 1, "LAST MONTH", 10);
          }
        );
        document.getElementById("query3").addEventListener(
          "click",
          function () {
            retrieveTracks("short_term", 1, "LAST MONTH", 20);
          }
        );
      },
      false
    ...
    document.getElementById("medium_term").addEventListener(
      ...
      function () {
        document.getElementById("query1").addEventListener(
          "click",
          function () {
            retrieveTracks("medium_term", 2, "LAST 6 MONTHS", 5);
            authCode();
          }
        );
        document.getElementById("query2").addEventListener(
          "click",
          function () {
            retrieveTracks("medium_term", 2, "LAST 6 MONTHS", 10);
            authCode();
          }
        );
        document.getElementById("query3").addEventListener(
          "click",
          function () {
            retrieveTracks("medium_term", 2, "LAST 6 MONTHS", 20);
            authCode();
          }
        );
      },
    ...
    document.getElementById("long_term").addEventListener(
      ...
      function () {
        document.getElementById("query1").addEventListener(
          "click",
          function () {
            retrieveTracks("long_term", 3, "ALL TIME", 5);
          }
        );
        document.getElementById("query2").addEventListener(
          "click",
          function () {
            retrieveTracks("long_term", 3, "ALL TIME", 10);
          }
        );
        document.getElementById("query3").addEventListener(
          "click",
          function () {
            retrieveTracks("long_term", 3, "ALL TIME", 20);
          }
        );
      },
      false
